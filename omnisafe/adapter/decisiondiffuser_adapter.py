...
class DecisionDiffuserAdpater:
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self.history_obs_length = self._cfgs.evaluate_cfgs.history_obs_length
    ...
    def evaluate(
        ...
        for _ in range(evaluate_epoisodes):
            ...
            while not done:
                ...
                action = agent.predict(obs.unsqueeze(0), step=int(ep_len), deterministic=True)
