...
# ==============================================================================
"""Implementation of the TD3PID (PID version of TD3Lag) algorithm."""
...
class TD3PID(TD3):
    """The TD3PID (PID version of TD3Lag) algorithm.

    References:
        - Title: Responsive Safety in Reinforcement Learning by PID Lagrangian Methods
        - Authors: Adam Stooke, Joshua Achiam, Pieter Abbeel.
        - URL: `TD3PID <https://arxiv.org/abs/2007.03964>`_
    """

    def _init(self) -> None:
        """The initialization of the DDPGPID algorithm.

        The TD3PID algorithm uses a PID-Lagrange multiplier to balance the cost and reward.
        """
        super()._init()
    ...
    def _loss_pi(
        ...
        The loss function in TD3PID is defined as:
