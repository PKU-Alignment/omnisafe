...
class Buffer:
    ...
    def __init__(
        ...
        Args:
            actor_critic (torch.nn.Module): The actor-critic model.
            ...
            standardized_obs (bool): Whether to standardize observations.
            standardized_reward (bool): Whether to standardize rewards.
            standardized_cost (bool): Whether to standardize costs.
    ...
    def pre_process_data(self) -> tuple((dict, dict)):
        """Pre-process.
