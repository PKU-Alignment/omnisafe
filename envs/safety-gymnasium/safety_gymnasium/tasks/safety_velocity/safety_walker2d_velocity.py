...
from safety_gymnasium.bases.mujoco_env import MujocoEnv
...
class SafetyWalker2dVelocityEnv(MujocoEnv, utils.EzPickle):
    """
    ## Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._velocity_threshold = 3.415
    ...
    def step(self, action):
        ...
        if self.viewer:
            self.add_velocity_marker(
                pos=self.get_body_com('torso')[:3].copy(), vel=x_velocity, cost=cost
            )
    ...
    def add_velocity_marker(self, pos, vel, cost):
        ...
        self.viewer.add_marker(
            pos=pos, size=0.2 * np.ones(3), type=mujoco.mjtGeom.mjGEOM_SPHERE, rgba=color, label=''
        )
